...
|---|---|---|
| [bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect) | CC BY-NC 4.0 | Bilibili endpoints, the WBI and cookie-refresh signing steps |
...
and in the README; its NonCommercial term applies to that documentation.
