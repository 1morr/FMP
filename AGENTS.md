...
| Settings | App settings (enabled audio sources, quality, auth, lyrics including `allowPlainLyricsAutoMatch` and AI modes, refresh intervals, stream priority per source) |
