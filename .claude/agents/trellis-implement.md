...
- `lib/services/audio/queue_manager.dart` - What changed
- `test/services/audio/queue_manager_test.dart` - Test that pins it
...
- User-visible: yes (on-device check needed) | no
```
