...
Future<bool> showAddToRemotePlaylistDialogMulti({
  ...
  final result = await showModalBottomSheet<bool>(
    ...
    useSafeArea: true,
    builder: (context) => _AddToRemoteFavSheet(tracks: tracks),
  );
  return result ?? false;
}

class _AddToRemoteFavSheet extends ConsumerStatefulWidget {
  final List<Track> tracks;
  const _AddToRemoteFavSheet({required this.tracks});

  @override
  ConsumerState<_AddToRemoteFavSheet> createState() =>
      _AddToRemoteFavSheetState();
}

class _AddToRemoteFavSheetState extends ConsumerState<_AddToRemoteFavSheet> {
