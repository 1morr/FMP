...
18. **多源歌词匹配**: 支持 lrclib + 网易云音乐 + QQ音乐歌词源，导入歌单时保存原平台ID可直接获取歌词（跳过搜索），自动匹配优先原平台ID直取 → 网易云 → QQ音乐 → lrclib，搜索弹窗支持源筛选，网易云支持翻译歌词和罗马音
